...
if (attack_array[0,0] = 0 && irandom_range(0,100) <= tile_oil_chance){
	var oil_hitbox = create_hitbox(spr_oil,true_column1_x,true_row1_y, 0, 3 * global.one_second,[obj_player],1,0);
	oil_hitbox.visible = true;
	global.ground[attack_x,attack_y] = 1;
}
if (attack_array[1,0] = 0 && irandom_range(0,100) <= tile_oil_chance){
	var oil_hitbox = create_hitbox(spr_oil,true_column2_x,true_row1_y, 0, 3 * global.one_second,[obj_player],1,0);
	oil_hitbox.visible = true;
	global.ground[attack_x + 1,attack_y] = 1;
}
if (attack_array[0,1] = 0 && irandom_range(0,100) <= tile_oil_chance){
	var oil_hitbox = create_hitbox(spr_oil,true_column1_x,true_row2_y, 0, 3 * global.one_second,[obj_player],1,0);
	oil_hitbox.visible = true;
	global.ground[attack_x,attack_y + 1] = 1;
}
if (attack_array[1,1] = 0 && irandom_range(0,100) <= tile_oil_chance){
	var oil_hitbox = create_hitbox(spr_oil,true_column2_x,true_row2_y, 0, 3 * global.one_second,[obj_player],1,0);
	oil_hitbox.visible = true;
